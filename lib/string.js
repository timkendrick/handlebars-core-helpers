...
module.exports['startsWith'] = function() {
	console.error('Warning: startsWith helper is deprecated. Use starts-with instead.');
	return module.exports['starts-with'].apply(this, arguments);
};
...
module.exports['escapeNewlines'] = function() {
	console.error('Warning: escapeNewlines helper is deprecated. Use escape-newlines instead.');
	return module.exports['escape-newlines'].apply(this, arguments);
};
